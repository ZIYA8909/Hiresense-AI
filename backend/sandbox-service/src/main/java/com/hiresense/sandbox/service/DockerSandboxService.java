    ...
    public Map<String, Object> executeCode(String language, String code, String input, String expectedOutput) {
        ...
        try {
            ...
            dockerClient.logContainerCmd(containerId)
                    .withStdOut(true)
                    .withStdErr(true)
                    .exec(new com.github.dockerjava.api.async.ResultCallbackTemplate<com.github.dockerjava.api.async.ResultCallbackTemplate, com.github.dockerjava.api.model.Frame>() {
                        @Override
