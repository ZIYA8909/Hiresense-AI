...
public class ApplicationService {
    ...
    private void sendApplicationEvent(String eventType, String email, Map<String, Object> data) {
        try {
            ...
            event.put("data", data);
            kafkaTemplate.send("recruitment-events", email, objectMapper.writeValueAsString(event));
        } catch (Exception e) {
            System.err.println("[ApplicationService] Warning: Failed to send Kafka event: " + e.getMessage());
        }
    }
}
